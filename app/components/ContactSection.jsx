...
export default function ContactSection() {
  ...
  return (
    <section className="w-full bg-[#1f514c] px-4 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <input
                    ...
                    onChange={handleChange}
                     className="w-full bg-[#2a5a55] border-[#2a5a55] rounded-2xl px-6 py-3 text-white placeholder-white focus:outline-none border focus:border-white transition-colors"
                    required
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <input
                    ...
                    value={formData.date}
                    onChange={handleChange}
                     className="w-full bg-[#2a5a55] border-[#2a5a55] rounded-2xl px-4 py-3 text-white placeholder-white focus:outline-none border focus:border-white transition-colors font-medium"
                ...
                <div>
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-[#2a5a55] border-[#2a5a55] rounded-2xl px-4 py-3 text-white focus:outline-none border focus:border-white transition-colors  font-medium appearance-none"
                    style={{
                      color: '#ffffff',
              ...
              <div>
                <textarea
                  ...
                  onChange={handleChange}
                  rows="5"
                  className="w-full bg-[#2a5a55] border border-[#2a5a55] rounded-2xl px-6 py-4 text-white placeholder-white focus:outline-none focus:border-white transition-colors resize-none"
                ></textarea>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="inline-flex items-center gap-3 bg-[#2a5a55] text-white font-semibold pl-6 pr-2 py-2 rounded-full hover:bg-teal-900 transition-colors text-base"
                >
