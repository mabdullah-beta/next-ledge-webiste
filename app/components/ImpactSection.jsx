        ...
        <div className="relative max-w-5xl mx-auto mt-20 mr-12">
          ...
          <div className="lg:hidden mb-8 space-y-6 px-4">
            ...
            <div className="grid grid-cols-2 gap-8">
              {/* $7M+ Revenue */}
              <div className="flex items-center gap-2 bg-[#fafafa] rounded-full px-3 py-1 ">
                <div className="bg-teal-800 text-white px-2 py-1 rounded-full">
              ...
              {/* 78% Impact */}
              <div className="flex items-center gap-2 bg-[#fafafa] rounded-full px-3 py-1 ">
                <div className="bg-teal-800 text-white px-3 py-1 rounded-full">
          ...
          <div className="absolute left-0 top-1/2 -translate-y-1/2 hidden lg:block w-full">
            <div className="relative">
              ...
              <div className="absolute left-8 top-[-140px] flex items-center">
                <div className="flex items-center gap-2 bg-[#fafafa] rounded-full px-3 py-1 ">
                  <div className="bg-teal-800 rounded-full px-3 py-1">
